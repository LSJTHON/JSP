...
public class bookinfoPepository {
	private ArrayList<bookinfo> listOfBooks = new ArrayList<bookinfo>();
	private static bookinfoPepository instance = new bookinfoPepository();
	public static bookinfoPepository getInstance() {
		return instance;
	}
	...
	public bookinfo getBookById(String bookId) {
		bookinfo bookById = null;
		
		for(int i =0; i < listOfBooks.size(); i++) {
			bookinfo book = listOfBooks.get(i);
	...
	public bookinfoPepository() {

		bookinfo book1= new bookinfo("ISBN1234"," DARK WEB(다크웹) ", 15000);
	      book1.setAuthor("황재호");
