	...
	<div class="container col-8 alert alert-info">
		...
		<div class="row justify-content-between">
			<div class="col-4" align="left">
				...
				주소 : <%out.println(shipping_addressName);%><br>(<%out.println(shipping_country); %>)<br>
			</div>
		...
		<div>
			<table class="table table-hover">
				...
				%>
				<tr>
					<td class="text-center"><em><%=bookinfo.getName() %></em></td>
					<td class="text-center"><%=bookinfo.getQuantity() %></td>
					<td class="text-center"><%=bookinfo.getUnitPrice() %></td>
